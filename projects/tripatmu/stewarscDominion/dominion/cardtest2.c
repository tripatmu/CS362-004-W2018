...
int main(){
    ...
    //Testing Smithy
    state->hand[currPlayer][hPosition]=smithy;
    
    printf("\nSet Smithy as First Hand Position\n");
    for(i=0; i<(state->handCount[currPlayer]-1);i++){
    ...
    cardEffect(smithy,c1,c2,c3,state,hPosition,&bonus);
